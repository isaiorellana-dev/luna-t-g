  ...
  return (
    <div className="lff">
      ...
      <p>
        ...
        <br />
        <br /> Cada día un restaurante diferente tendrá a la venta una promoción
        o un combo que será vendido exclusivamente por nuestro servicio de
        delivery (Para estar al tanto de las promociones te recomendamos que nos
        sigas en todas nuestras redes sociales).
        <br />
        <br />
        ...
        ganador según la valoración de nuestros clientes y la cantidad de ventas
        que genere.
        <br />
